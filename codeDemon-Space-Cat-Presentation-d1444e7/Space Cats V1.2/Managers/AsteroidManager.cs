...
namespace Space_Cats_V1._2
{
    class AsteroidManager
    {
        ...
        private static AsteroidManager z_instance;
        ...
        public static AsteroidManager getInstance(AsteroidManagerState newState, Rectangle viewPort, ContentManager content, SpriteBatch spriteBatch)
        {
            if (z_instance == null)
                z_instance = new AsteroidManager(newState, viewPort, content, spriteBatch);
            return z_instance;
        }
