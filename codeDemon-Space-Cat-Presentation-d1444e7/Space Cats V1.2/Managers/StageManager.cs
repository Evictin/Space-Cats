...
namespace Space_Cats_V1._2
{
    class StageManager
    {
        ...
        public StageManager(SpriteBatch spriteBatch, Rectangle viewPort, ContentManager content)
        {
            ...
            this.z_backgroundManager.loadImage1(this.z_contentManager.Load<Texture2D>("Content\\Textures\\Starscape4"));
            this.z_backgroundManager.loadImage2(this.z_contentManager.Load<Texture2D>("Content\\Textures\\Starscape4"));
            ...
            this.z_asteroidManager = AsteroidManager.getInstance(AsteroidManager.AsteroidManagerState.None, this.z_viewportRec,
